...
export default function RSVP() {
    ...
    const handleSubmit = async (e) => {
        ...
        // Build payload explicitly to avoid sending intermediate form keys that don't exist in the DB
        const payload = {
            invitee_name: name,
            attendance: form.attendance || null,
            drink_non_alc: form.drink_non_alc || null,
            drink_alc: form.drink_alc || null,
            food: form.food || null,
            bringing: form.bringing || null,
            mad_libs: madLibs || null,
        };
        ...
        if (error) {
            ...
            alert('Failed to submit RSVP: ' + (error.message || JSON.stringify(error)));
            return;
        }

        // success: refresh any local caches/lists if needed
        try { fetchBringList(); } catch (e) { /* ignore */ }
